...
class Battery: #(3)
    ...
    def describe_battery(self):
        """Print a statement descrxibing the battery size."""
        print(f"This car has a {self.battery_size}-kWh battery.")

    def get_range(self): #(4)
...
class ElectricCar(car):
    ...
    def __init__(self, make, model, year):
        ...
        The initialzie attributes specific to an electric car.
        """
...
my_leaf.battery.describe_battery() #(3)
my_leaf.battery.get_range() #(4)
...
# We then define the child class, ElectricCar
# The name of the parent class must be included in parentheses in the definition
# of a child class. The __init__ () method takes in the information required
...
# from car, which gives electric car instance all the attributes
